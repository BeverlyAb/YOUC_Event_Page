...
class YOUCInterestedButton: UIButton {
    var isOn = false
    ...
    func initButton() {
        ...
        addTarget(self, action: #selector(YOUCInterestedButton.buttonPressed), for: .touchUpInside)
    }
